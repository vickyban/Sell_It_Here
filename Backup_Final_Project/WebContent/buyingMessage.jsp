...
<%
	...
	ArrayList<MessageBean> messages = MessageDAO.getBuyingMessage(user.getId());
	pageContext.setAttribute("message", messages);	
	
	if(session.getAttribute("prodID") != null && session.getAttribute("sendTo") != null)
	{
...
<%@ include file="/header.jsp"%>
   ...
   <div id="navBar">
		<div id="center">
			<ol>
				...
				<li class="horizontal"><a href="${pageContext.request.contextPath}/buyingMessage.jsp" style="border:.5px solid black;
  ...
  <div id="content">
		<div id="center2">
			<ol>
				<li class="horizontal2"><a href="${pageContext.request.contextPath}/buyingMessage.jsp" style="border-bottom:6px solid rgb(255, 63, 85);color:rgb(255, 63, 85);" >  Buying </a></li> 
		...
		<c:forEach items="${message}" var="inquiry">	
				<c:choose>	
					<c:when test="${inquiry.isRead() == 'false'}">			
							<td id="user"><b> ${inquiry.recipientUser} </b> </td>
					...
					<c:otherwise>
							<td id="user"> ${inquiry.recipientUser} </td>
